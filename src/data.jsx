...
const ECOSYSTEM_MODULES = [
  { id: 'captura', label: 'Captura', short: 'Pré-captura',
    desc: 'Captura de processos judiciais antes da citação, ganhando tempo de resposta.',
    tier: 'both' },
  { id: 'cadastro', label: 'Cadastro', short: 'Cadastro',
    desc: 'Capa e contexto processual completo, padronizado para a operação.',
    tier: 'sbk' },
  { id: 'monitoramento', label: 'Monitoramento', short: 'Monitoramento',
    desc: 'Acompanhamento de movimentações e peças processuais em 99% dos tribunais.',
    tier: 'both' },
  ...
  { id: 'oficios', label: 'Ofícios', short: 'Ofícios',
    ...
    tier: 'sbk' },
  { id: 'subsidios', label: 'Subsídios e Laudos', short: 'Subsídios',
    desc: 'Busca padronizada e motor de geração automática de laudos técnicos.',
    tier: 'sbk' },
  { id: 'obrigacoes', label: 'Obrigações de Fazer', short: 'Obrigações',
    desc: 'Controle de valores e prazos de obrigações de fazer e não-fazer.',
    tier: 'sbk' },
  { id: 'firmas', label: 'Firmas e Poderes', short: 'Firmas',
